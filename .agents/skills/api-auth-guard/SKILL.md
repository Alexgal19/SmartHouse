...
Reguła #4 ("Każde API route wymaga auth") w [AGENTS.md](../../../AGENTS.md) i [AGENTS.md](../../../AGENTS.md). Brak autoryzacji = bezpośrednie ryzyko wycieku danych mieszkańców i pracowników.
