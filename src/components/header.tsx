...
export default function Header({ user, activeView, notifications, onNotificationClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-4 z-30 mx-4 flex h-14 items-center gap-4 rounded-2xl border bg-card/60 px-4 shadow-lg shadow-orange-400/10 backdrop-blur-xl sm:px-6">
