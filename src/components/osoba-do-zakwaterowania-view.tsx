                            ...
                            {doZakwaterowania.length === 0 ? (
                                ...
                                doZakwaterowania.map((candidate) => (
                                    <div
                                        ...
                                        className={`bg-card rounded-lg p-4 border border-border shadow-sm flex flex-col gap-2 relative overflow-hidden transition-colors hover:bg-accent/50 cursor-pointer animate-pulse-light ${
