  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "hidden md:flex flex-col m-2 rounded-2xl bg-card/60 backdrop-blur-xl border shadow-lg shadow-black/5 duration-200 transition-[width] ease-in-out",
            "h-[calc(100svh-1rem)]",
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-8 w-full bg-transparent border-sidebar-border shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring",
        className
      )}
      {...props}
    />
