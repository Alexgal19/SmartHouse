import type { TD1Result, TD2Result, TD3Result, MRZResult } from './types';
import { validateTD1CheckDigits, validateTD2CheckDigits, validateTD3CheckDigits } from './checkdigit';
